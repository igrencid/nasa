const SITE_DATA = {
  hero: {
    kicker: "MY EXO CONCERT ALBUM",
    title: "A Night to Remember with <span>EXO</span>",
    subtitle: "A digital album of my favorite moments from the night I watched EXO live.",
    spotlightTitle: "EXO Concert Night",
    spotlightImage: "assets/images/hero-memory.jpg",
    ticketTitle: "EXO PLANET",
    ticketDate: "Live Memory"
  },

  stats: [
    { value: "24+", label: "Photos" },
    { value: "06", label: "Stories" },
    { value: "01", label: "Best Night" }
  ],

  memories: [
    {
      title: "Perjalanan ke Venue",
      category: "before",
  ...
  videos: [
    ...
    {
      title: "Encore Stage",
      desc: "Ending konser yang bikin susah move on.",
      duration: "01:40",
      poster: "assets/images/video-3.jpg",
      src: "assets/videos/encore-stage.mp4"
    }
  ],
